...
<body> 
    <div class="container m-5"> 
        ...
        <div class="list-group list-group-numbered mt-4"> 
            <a href="{{ route('lynxc') }}" class="list-group-item list-group-item-action"> 
                Lynxc Route 
            </a>
            <a href="{{ url('/basic_routing') }}" class="list-group-item list-group
            item-action"> 
           Basic Routing (No View, No Controller) 
            </a>
            <a href="{{ url('/view_route') }}" class="list-group-item list-group
            item-action"> 
            View Route 
            </a>
            <a href="{{ url('/controller_route') }}" class="list-group-item list
            group-item-action"> 
            Controller Route 
            </a>
            ...
            <a href="{{ url('/user/12345') }}" class="list-group-item list-group
            item-action"> 
            ...
            <a href="{{ route('profileRouteName', ['profileId' => '123']) }}" 
                ...
                <a href="{{ url('/route_priority/user') }}" class="list-group-item list
                group-item-action"> 
                    Route Priority 
                </a>
                ...
                <h6 class="mt-4">Route Groups (Route Prefixes & Route Name Prefixes)</h6> 
                    <div class="list-group list-group-numbered mt-4"> 
                        <a href="{{ route('admin.dashboard') }}" class="list-group-item list
                    group-item-action"> 
                            Admin Dashboard 
                        </a> 
